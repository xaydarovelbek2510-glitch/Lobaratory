  ...
  template: `
    ...
    <section class="page-content"><div class="container page-grid">
      ...
      <div class="main-content">
        <h2>lab molecular laboratoriyasi haqida batafsil</h2>
        <p>Bu sahifa lab molecular laboratoriyasi haqida to'liq ma'lumot beradi. Laboratoriya zamonaviy jihozlar bilan jihozlangan va xalqaro standartlarga mos keladi.</p>
