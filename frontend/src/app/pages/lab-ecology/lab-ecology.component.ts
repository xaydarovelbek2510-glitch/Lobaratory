...
@Component({
  ...
  template: `
    <div class="page-header"><div class="container"><h1>lab ecology laboratoriyasi</h1><div class="breadcrumb"><a routerLink="/">Bosh sahifa</a> › <a routerLink="/laboratories">Laboratoriyalar</a> › <span>lab ecology</span></div></div></div>
    <section class="page-content"><div class="container page-grid">
      <app-sidebar [title]="'LABORATORIYALAR'" [links]="labLinks"></app-sidebar>
      <div class="main-content">
        <h2>lab ecology laboratoriyasi haqida batafsil</h2>
        <p>Bu sahifa lab ecology laboratoriyasi haqida to'liq ma'lumot beradi. Laboratoriya zamonaviy jihozlar bilan jihozlangan va xalqaro standartlarga mos keladi.</p>
